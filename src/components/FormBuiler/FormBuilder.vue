<template>
  <div class="row">
    <div v-for="(input, inputIndex) in inputData" :key="inputIndex" class="q-pa-md" :class="(input.col) ? input.col : 'col'">
      ...
      <form-builder-select v-if="input.type === 'select'" @input="change($event)" v-model="input.value" :options="input.options" :label="input.label" :option-value="input.optionValue" :multiple="input.multiple" :use-chips="input.useChips" :create-new-value="input.createNewValue" :option-label="input.optionLabel" :disable="disable || input.disable" />
      <form-builder-file v-if="input.type === 'file'" @input="change($event)" v-model:value="input.value" :label="input.label" :disable="disable || input.disable" />
      ...
      <form-builder-option-group v-if="input.type === 'optionGroupToggle'" @input="change($event)" v-model="input.value" :options="input.options" :type="'toggle'" :disable="disable || input.disable" />
      <form-builder-slider v-if="input.type === 'slider'" @input="change($event)" v-model="input.value" :min="input.min" :max="input.max" :label="input.label" :disable="disable || input.disable" />
      <form-builder-range-slider v-if="input.type === 'rangeSlider'" @input="change($event)" v-model="input.value" :min="0" :max="50" :label="input.label" :disable="disable || input.disable" />
      <form-builder-date-time v-if="input.type === 'dateMultipleRange'" @input="change($event)" v-model="input.value" :label="input.label" range multiple :disable="disable || input.disable"/>
      <form-builder-date-time v-if="input.type === 'dateRange'" @input="change($event)" v-model="input.value" :label="input.label" range :disable="disable || input.disable" />
      <form-builder-date-time v-if="input.type === 'dateTime'" @input="change($event)" v-model="input.value" :label="input.label" :disable="disable || input.disable" />
      <form-builder-date-time v-if="input.type === 'time'" @input="change($event)" v-model="input.value" :label="input.label" time :disable="disable || input.disable"/>
