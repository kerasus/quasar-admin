...
export default {
  ...
  data () {
    return {
      ...
      inputs: [
        { type: 'file', name: 'photo', responseKey: 'data.photo', value: null, size: '250px', col: 'col-md-3' },
        ...
        { type: 'input-editor', name: 'short_description', responseKey: 'data.description.short', value: 'null', label: 'توضیحات مختصر', col: 'col-md-6' },
        { type: 'input-editor', name: 'long_description', responseKey: 'data.description.long', value: 'null', label: 'توضیحات اجمالی', col: 'col-md-6' },
        { type: 'input-editor', name: 'special_description', responseKey: 'data.description.special', value: 'null', label: 'توضیحات خاص', col: 'col-md-6' },
        { type: 'select', name: 'tags', options: [], responseKey: 'data.tags', value: null, multiple: true, useChips: true, createNewValue: true, label: 'تگ ها', col: 'col-md-3' },
        { type: 'select', name: 'sample_contents', options: [], responseKey: 'data.sample_contents', value: null, multiple: true, useChips: true, createNewValue: true, label: 'کانتنت های معرفی کننده محصول', col: 'col-md-3' },
        { type: 'select', name: 'recommender_contents', options: [], responseKey: 'data.recommender_contents.recommenders.contents', value: null, multiple: true, useChips: true, createNewValue: true, label: 'کانتنت های پیشنهاد دهنده محصول', col: 'col-md-3' },
        { type: 'select', name: 'recommender_sets', options: [], responseKey: 'data.recommender_contents.recommenders.sets', value: null, multiple: true, useChips: true, createNewValue: true, label: 'ست های دارای کانتنتهای پیشنهاد دهنده محصول', col: 'col-md-3' }
      ]
    }
  },
  created () {
